...
SELECT
	posts.id, posts.image_url, posts.user_id, users.username, users.first_name, users.last_name
FROM 
	posts
...
SELECT 
	posts.id, posts.pub_date, following.following_id
FROM 
	following
INNER JOIN posts 
...
SELECT 
	posts.id, posts.pub_date, following.following_id, users.username
FROM 
	following
INNER JOIN posts 
	ON following.following_id = posts.user_id
