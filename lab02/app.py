...
#########################
current_user = CurrentUser(first_name='Willa', last_name='Barnett', email='willab22@gmail.com', username='willyrules')
...
@app.route('/')
def exercise1():
    return 'Hello, {} {}! Woah, I like your username: {}'.format(current_user.first_name, current_user.last_name, current_user.username) 
